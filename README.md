...
Git watcher is a [cli](https://en.wikipedia.org/wiki/Command-line_interface) program to control all your commits doing somethings like saving all your commits and it can get back to old archive versions in instants
